            ...
            self.transform = albu.Compose(
                             [
                                 ...
                                 albu.ShiftScaleRotate(p=1,
                                                       ...
                                                       # FIX: Reverting to original 'value' for older Albumentations versions
                                 ...
                                 [
                                     albu.MultiplicativeNoise(p=0.2,
                                                              ...
                                                              per_channel=True ,
                                                              elementwise=True),
                                     # FIX: Reverting to original 'scale_min/max' for older Albumentations versions
            ...
            self.transform = albu.Compose(
                             [
                                 ...
                                 albu.ShiftScaleRotate(p=1,
                                                       ...
                                                       interpolation=cv2.INTER_LINEAR,
                                                       border_mode=cv2.BORDER_CONSTANT,
                                                       # FIX: Reverting to original 'value'
                                                       value=(193,193,193,193)), 
                                 CustomTransforms.Rotate90(p=1), #immer p=1
                                 albu.Resize(512, 512, interpolation=cv2.INTER_LINEAR), 
                                 albu.RandomBrightnessContrast(p=0.2,
                                 ...
                                 [
                                     albu.MultiplicativeNoise(p=0.2,
                                                              ...
                                                              per_channel=True ,
                                                              elementwise=True),
                                     # FIX: Reverting to original 'scale_min/max'
                                     albu.Downscale(p=0.3, scale_min=0.5, scale_max=0.5) 
                                 ], p=0.5)
                             ], p=1,
                             keypoint_params=albu.KeypointParams(format='yx')
